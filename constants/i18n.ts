...
export const translations = {
  en: {
    ...
    thresholdsHint: 'Choose how many ticks add up to a merit, and how many crosses to a detention.',
    ticksForMeritLabel: 'Ticks per merit',
    crossesForDetentionLabel: 'Crosses per detention',
    thresholdDecrease: 'Decrease {label}',
    thresholdIncrease: 'Increase {label}',
  ...
  fr: {
    ...
    thresholdsHint:
      'Choisissez combien de ticks donnent un mérite et combien de croix déclenchent une retenue.',
    ticksForMeritLabel: 'Ticks par mérite',
    crossesForDetentionLabel: 'Croix par retenue',
    thresholdDecrease: 'Diminuer {label}',
    thresholdIncrease: 'Augmenter {label}',
    ...
    eventOptions: 'Options de l’entrée',
    typeTick: 'Tick',
    typeCross: 'Croix',
  ...
  es: {
    ...
    thresholdsHint: 'Elige cuántas marcas suman un mérito y cuántas cruces, una sanción.',
    ticksForMeritLabel: 'Marcas por mérito',
    crossesForDetentionLabel: 'Cruces por sanción',
    thresholdDecrease: 'Disminuir {label}',
    thresholdIncrease: 'Aumentar {label}',
    sectionTrimester: 'Trimestre',
    ...
    eventOptions: 'Opciones de la entrada',
    typeTick: 'Marca',
    typeCross: 'Cruz',
