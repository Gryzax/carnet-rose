...
const styles = StyleSheet.create({
  snack: { position: 'absolute', left: 16, right: 16, bottom: 18, backgroundColor: colors.textDark, borderRadius: 20, padding: 14, flexDirection: 'row', justifyContent: 'space-between', gap: 12 },
  text: { color: colors.white, fontFamily: 'NunitoSans_600SemiBold', flex: 1 },
