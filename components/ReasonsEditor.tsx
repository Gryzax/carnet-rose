...
const styles = StyleSheet.create({
  container: { gap: 10 },
  hint: { color: colors.muted, fontFamily: typography.regular, fontSize: 19, lineHeight: 24 },
  groupLabel: {
    color: colors.muted,
  ...
  reasonText: { flex: 1, color: colors.ink, fontFamily: typography.regular, fontSize: 20 },
  ...
  dialog: { gap: 12 },
  dialogTitle: { fontSize: 28, fontFamily: typography.regular, color: colors.ink },
});
