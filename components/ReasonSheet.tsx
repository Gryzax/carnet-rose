  ...
  return (
    <Modal transparent visible={visible} animationType="none" onRequestClose={onClose}>
      ...
      <Animated.View testID="reason-sheet" style={[styles.sheet, { transform: [{ translateY: y }] }]}>
        ...
        <ScrollView testID="reason-sheet-scroll" style={styles.reasonList} keyboardShouldPersistTaps="handled">
          {reasons.map((reason) => (
            <Pressable
              key={reason}
              accessibilityRole="button"
...
const styles = StyleSheet.create({
  ...
  sheet: { position: 'absolute', left: 12, right: 12, bottom: 24, maxHeight: '88%', backgroundColor: colors.card, borderRadius: 20, borderColor: colors.border, borderWidth: 1.5, padding: 18 },
